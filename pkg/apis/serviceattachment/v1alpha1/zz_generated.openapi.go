...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"k8s.io/ingress-gce/pkg/apis/serviceattachment/v1alpha1.ResourceReference":       schema_pkg_apis_serviceattachment_v1alpha1_ResourceReference(ref),
...
func schema_pkg_apis_serviceattachment_v1alpha1_ResourceReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_serviceattachment_v1alpha1_ServiceAttachmentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"resourceReference": {
						SchemaProps: spec.SchemaProps{
							Description: "ResourceReference is the reference to the K8s resource that created the forwarding rule Only Services can be used as a reference ResourceReference *core.TypedLocalObjectReference `json:\"resourceReference\"`",
							Ref:         ref("k8s.io/ingress-gce/pkg/apis/serviceattachment/v1alpha1.ResourceReference"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/ingress-gce/pkg/apis/serviceattachment/v1alpha1.ResourceReference"},
	}
}
