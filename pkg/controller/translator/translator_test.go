...
func TestPathValidation(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			desc:          "Valid ImplementationSpecific path without wildcard",
		...
		{
			desc:          "Valid ImplementationSpecific path with wildcard",
			pathType:      v1beta1.PathTypeImplementationSpecific,
			path:          "/test/*",
			expectValid:   true,
			expectedPaths: []string{"/test/*"},
		...
		{
			desc:          "Valid ImplementationSpecific empty path",
			pathType:      v1beta1.PathTypeImplementationSpecific,
			path:          "",
			expectValid:   true,
			expectedPaths: []string{"/*"},
		...
		{
			desc:        "Invalid ImplementationSpecific path with invalid wildcard",
			pathType:    v1beta1.PathTypeImplementationSpecific,
			path:        "/test*",
			expectValid: false,
		},
